...
public class Principal {
	...
	public static Reserva receberReserva() {
		...
		aux.setDataVoo(in.nextLine());
		System.out.println("Hora do voo:");
		aux.setHoraVoo(in.nextLine());
		...
		while(!sair) {
			...
			if(cid == 0) {
				...
				try {
					aux.setOrigem(reservaPassagem.getListaDeCidades().get(cid-1));
					sair = true;
					break;
				}catch(Exception e) {
		...
		while(!sair) {
			...
			if(cid == 0) {
				...
				try {
					aux.setDestino(reservaPassagem.getListaDeCidades().get(cid-1));
					sair = true;
					break;
				}catch(Exception e) {
					System.out.println("Cidade nao encontrada");
	...
	public static Trecho receberTrecho() {
		...
		aux.setDataPartida(in.nextLine());
		System.out.println("Data de chegada");
		aux.setDataChegada(in.nextLine());
		System.out.println("Hora de partida");
		aux.setHoraPartida(in.nextLine());
		System.out.println("Hora de chegada");
		aux.setHoraChegada(in.nextLine());
		...
		while(!sair) {
			...
			if(aer == 0) {
				...
				try {
					aux.setAeroportoOrigem(reservaPassagem.getListaDeAeroportos().get(aer-1));
					sair = true;
					break;
				}catch(Exception e) {
		...
		while(!sair) {
			...
			if(aer == 0) {
				...
				try {
					aux.setAeroportoDestino(reservaPassagem.getListaDeAeroportos().get(aer-1));
					sair = true;
					break;
				}catch(Exception e) {
					System.out.println("Aeroporto nao encontrado");
	...
	public static Aeroporto receberAeroporto() {
		...
		while(!sair) {
			...
			if(cid == 0) {
				...
				try {
					aux.setCidade(reservaPassagem.getListaDeCidades().get(cid-1));	
